...
class Escalator:
    ...
    async def escalate(
        self, *, customer_id: str, reason: str, transcript: str, note: str | None = None
    ) -> None:
        ...
        await self._mail(subject=f"[HỖ TRỢ][{customer_id}] {reason}", body=head + transcript)
    ...
    async def _mail(self, *, subject: str, body: str) -> None:
